...
//Öğrenciler ve notlar isminde iki tane dizi oluşturunuz ve dizi elemanlarını kullanıcıdan aldığınız değerle doldurunuz (3 öğrenci)
//Öğrenciler dizisi kaç elemanlıdır yazdırınız
//İlk iki öğrencinin ad ve not bilgisini yazdırınız
//Tüm öğrencilerin ortalaması nedir?
